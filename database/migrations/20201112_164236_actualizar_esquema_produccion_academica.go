...
func (m *ActualizarEsquemaProduccionAcademica_20201112_164236) Up() {
	...
	file, err := ioutil.ReadFile("../scripts/20201112_152514_ActualizarEsquemaProduccionAcademica.up.sql")
...
func (m *ActualizarEsquemaProduccionAcademica_20201112_164236) Down() {
	...
	file, err := ioutil.ReadFile("../scripts/20201112_152514_ActualizarEsquemaProduccionAcademica.down.sql")
